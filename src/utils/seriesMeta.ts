...
const SERIES: Array<{ slug: RegExp; key: string; order: number; labelZh: string; labelEn: string }> = [
  ...
  { slug: /^pm-product-rhythms-ai-\d+$/, key: 'pm-product-rhythms-ai', order: 10, labelZh: '10. AI 時代的產品節奏', labelEn: '10. Product Rhythms in the Age of AI' },
  ...
  { slug: /^the-atlas-of-agent-design-patterns-part-\d+$/, key: 'the-atlas-of-agent-design-patterns', order: 14, labelZh: '14. Agent 設計模式圖鑑', labelEn: '14. The Atlas of Agent Design Patterns' },
];
