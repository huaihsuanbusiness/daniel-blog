...
It is one of PyTorch’s MPS memory-control environment variables. The official docs expose it as part of allocator tuning. That matters because it helps you understand what it is not: it is not a magic model shrink ray. Loosening it can sometimes shift behaviour. It does not necessarily fix the underlying mismatch between workload and hardware.
