---
title: "From Pain to Venture Part 01 | Do not start with the idea. Start by admitting where things are stuck."
...
1. **Important**: it matters enough to affect behaviour.
2. **Unfulfilled**: existing alternatives do not satisfy it well enough, or the cost is too high.
...
1. Whose important expectation gap is this?
2. How did this important expectation gap form?
3. What challenges must be faced to solve it?
4. What solution can dissolve the bottleneck behind the expectation gap?
5. How will success and value be defined? What concrete, testable indicators can be observed?
6. What value does the solution create, and what future meaning or development could it open?
