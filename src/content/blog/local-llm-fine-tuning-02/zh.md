...
這就是 catastrophic forgetting 的核心：模型在學新任務、新資料、新偏好時，犧牲了舊能力或舊知識的穩定性。Google Research 在 2025 年提出 Nested Learning 時，特別就是把這件事重新框起來。他們把模型視為多層、巢狀的最佳化問題，主張現有深度學習的記憶與更新其實一直被壓得太平，才會讓 continual learning 特別容易卡在新舊能力互相打架。citeturn743259search3turn743259search19
...
Google Research 對 Nested Learning 的說法，剛好能幫這些問題多一個視角：模型之所以難以持續學習，不是因為資料不夠，而可能是我們原本就把多層記憶與更新這件事想得太扁。citeturn743259search3turn743259search19
