...
**當你沒有唯一標準答案，只有「這個比較好、那個比較差」的偏好時，模型到底該怎麼學？**
...
而是把它換了一種更能直接訓的寫法。citeturn187255view0turn442250view2
...
Cameron 那篇對這段講得很好，因為它把 Bradley–Terry 擺回「偏好不是口號，而是可訓的機率模型」這個位置。citeturn442250view2
...
這就是所謂 **implicit reward**。citeturn187255view0turn442250view2
...
**DPO 不是把 chosen 背起來，而是在訓模型：讓 chosen 相對 reference 的位置，贏過 rejected 相對 reference 的位置。** citeturn442250view1turn442250view0
...
但如果只停在這裡，又會太薄。  
Cameron 和 SuperAnnotate 都有提到這層教學直覺，但如果要寫成更耐看的技術專欄，這裡一定要再往前一步。citeturn442250view4turn442250view3
...
都寫成由 policy 與 reference 的相對 log-prob 推出的 implicit reward 指標。citeturn442250view0turn442250view1
...
它們在吃的資料、最小 loss 結構、log 指標，全部都不一樣。citeturn187255view1turn442250view1
