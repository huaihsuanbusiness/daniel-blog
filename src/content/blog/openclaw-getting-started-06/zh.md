...
# OpenClaw Getting Started 06｜模型怎麼選？從 OpenAI、Claude、Gemini、Grok、MiniMax、z.ai 到本地模型的實戰選型
...
這篇目前以表格與段落為主，不需要額外配圖。  
如果之後要補圖，我只會考慮做一張「供應商路徑與成本感分層圖」的 SVG，放在選型表後面，不會為了熱鬧硬塞圖。
