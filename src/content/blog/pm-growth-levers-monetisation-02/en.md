---
title: "PM Growth Levers and Monetisation 02 － Value Proposition, Message Tests, and Landing Pages: Many Growth Experiments Fail Because the Promise Is Vague"
description: "A surprising number of growth problems are really translation problems."
categories: ["pm"]
tags: []
...
The product may not be broken.
The value may exist.
The team may have shipped quite a lot.
...
NN/g’s advice on homepage design is refreshingly blunt. The homepage and hero space are not there to impress first. They are there to help people grasp who you are, what you do, and why it matters to them. If users have to infer all of that, many will simply leave. [^nng-homepage]
...
For whom do you matter most?
What kind of value do you win on?

April Dunford makes the distinction clearly: positioning is not messaging. Positioning establishes the frame in which the product should be understood. Messaging then translates that frame for different buyers and channels. [^aprildunford]
...
NN/g puts it neatly: a value proposition should answer the question, “Why should I choose this site or company over others?” If that remains unclear, more traffic simply magnifies the ambiguity. [^nng-value]
...
Google Ads’ guidance is explicit here: your landing page should match your ad and keywords closely, so people can quickly find what they expected when they clicked. That is not only a UX issue. It also affects ad relevance and landing page experience. [^google-ads-landing]
...
NN/g’s stance is sensible: do not make people guess. If your brand name does not already explain the business, your hero needs a concise, explicit line that does. Generic welcomes and vague slogans are a bad use of the most valuable space on the page. [^nng-homepage]
...
NN/g stresses this too. A value proposition should be expressed in language users understand and care about, not in internal jargon or feature-heavy brand phrasing. [^nng-value]
...
[^nng-homepage]: Nielsen Norman Group, “Homepage Design: 5 Fundamental Principles”.
[^nng-value]: Nielsen Norman Group, “Homepage Design: 5 Fundamental Principles”.
[^aprildunford]: April Dunford, “A Product Positioning Exercise”.
[^google-ads-landing]: Google Ads Help, “Optimize your ads and landing pages”.
[^optimizely-ab]: Optimizely, “How is multivariate testing different from A/B testing?”.
